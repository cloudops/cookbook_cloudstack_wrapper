...
#cookbook 'cloudstack', path: '../cloudstack'
metadata
...
cookbook 'co_disk',         git:'git@git.cloudops.net:cookbooks/co-disk.git'
cookbook 'filesystem', git: 'https://github.com/xblitz/filesystem_cookbook.git', branch: "lvm4"
